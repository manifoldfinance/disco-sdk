...
export class MultiNonceReplayProtection extends ReplayGuard {
  ...
  private async getLatestMultiNonce() {
    ...
    //  check to see if we have we used this nonce before
    if (!storedNonce) {
      // let's grab it from the contract.
